...
export default function Header() {
    ...
    return (
        <div className={'border-b bg-orange-600'}>
            <header
                className="container flex items-center justify-between w-full max-w-3xl px-6 py-10 mx-auto xl:max-w-5xl border-b">
            ...
            <div
                ...
                <div className={'px-2 py-1 font-medium text-white bg-orange-500 rounded-md text-xl'}>
                    <Link href={route('page.tags')} className="p-1">All</Link>
                </div>
            </div>
        </div>
    )
