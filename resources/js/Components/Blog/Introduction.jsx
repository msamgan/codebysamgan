        ...
        <section className="max-w-4xl px-6 mx-auto space-y-12 bg-gray-100 text-gray-900">
            <div className="">
                ...
                <div className="flex justify-center pt-4 space-x-4 align-center">
                    <a rel="noopener noreferrer" href="https://github.com/msamgan" aria-label="GitHub"
                    ...
                    <a rel="noopener noreferrer" href="https://twitter.com/msamgank" aria-label="Twitter"
                       className="p-2 rounded-md text-gray-800 hover:text-orange-600">
                    ...
                    <a rel="noopener noreferrer" href="mailto:mohdsamgankhan@gmail.com" aria-label="Email"
                       className="p-2 rounded-md text-gray-800 hover:text-orange-600">
                        <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
                             className="w-6 h-6 fill-current">
                            <path
